# Seleção de Temas — Lives Isabel Tunas

> **Para o analista:** a cada ciclo, os 10 temas candidatos gerados são listados abaixo
> (5 de Empreendedorismo + 5 de Tema Livre). Sua função aqui é **escolher os vencedores**:
> marque **1 tema vencedor para a Live de Empreendedorismo** e **1 tema vencedor para a
> Live Livre** em cada ciclo.
>
> **Como marcar:** troque `- [ ]` por `- [x]` no tema escolhido e registre o nome dele
> na linha **"🏆 Vencedores deste ciclo"** ao final do ciclo. Marque apenas um por bloco.
...
<!--
MODELO PARA OS PRÓXIMOS CICLOS (copie o bloco abaixo no topo, logo após o cabeçalho):
